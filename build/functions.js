 ...
 */
export function getOverlappingCategory(object) {
 ...
 */
export function getHeight(element, withPadding, withBorder, withMargin) {
 ...
 */
export function getWidth(element, withPadding, withBorder, withMargin) {
    let styleEle = getComputedStyle(element);
