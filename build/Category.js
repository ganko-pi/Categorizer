...
export class Category extends Container {
    ...
    editName() {
        ...
        let buttonsContainerCategoryHeader = this.htmlObject.querySelector(".buttonsContainerCategoryHeader");
        ...
        let categoryName = this.htmlObject.querySelector(".categoryName");
     ...
     */
    addElementWithoutDueDateAtIndex(element, index) {
